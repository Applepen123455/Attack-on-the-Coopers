...
{
  let IMG=diff().epstein?EPSTEIN_IMG:ALT_ENEMY_IMG;
  let CROP=diff().epstein?EPSTEIN_CROP:ALT_ENEMY_CROP;
  let halo=diff().epstein?(e.elite?'#ff7bff':'#ff4d6d'):(e.type=='healer'?'#6aff9e':e.type=='shield'?'#62e3ff':e.type=='sniper'?'#ffd166':e.type=='bomber'?'#ff8fab':(e.elite?'#b28dff':e.col));
